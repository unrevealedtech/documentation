...
Unrevealed comes with a CLI that lets you generate code. Using the CLI will allow you to automaticaly type the SDKs. This has multiple benefits:
...
<figure>
  <img
    src="/img/docs/code-generation/autocomplete-example.gif"
    alt="Autocomplete"
  />
